...
#include "dynamic-runner-parser.cpp"
...
class DynamicRunner : public MatrixRunner {

public:

    DynamicRunner(int framesPerSecond, CanvasLayerPosition position, DynamicRunnerParser *parser) : MatrixRunner(
...
private:
    ...
    */
    ...
    void registerGraphics() {
        ...
        chai->add(fun(&DynamicRunner::createDrawableText, this), "_DrawableText");
        ...
        chai->add(fun(&DynamicRunner::createDrawableRectangle, this), "_DrawableRectangle");
